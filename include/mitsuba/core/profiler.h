...
enum class ProfilerPhase : int {
    ...
    SMSCaustics,
    SMSSamplePath,              /* SMS::sample_path()   xxf add */  
    SMSSamplePathReuse,         /* SMS::sample_path_reuse()   xxf add */
    SMSNewtonSolverFirst,                /* SMSNewtonSolverFirst  xxf add */
    SMSNewtonSolverSecond,                /* SMSNewtonSolverSecond  xxf add */
    SMSNewtonSolver,                /* SMSNewtonSolver1  xxf add */
    SMSCausticsBernoulliTrials,
    //SMSNewtonSolver2,                [> SMSNewtonSolver2  xxf add <]
    SMSGlints,
...
constexpr const char
    *profiler_phase_id[int(ProfilerPhase::ProfilerPhaseCount)] = {
        ...
        "SMS::Caustics",
        "SMS::sample_path()",
        "SMS::sample_path_reuse()",
        "SMS::newton_solver_first()",  
        "SMS::newton_solver_second()",  
        "SMS::NewtonSolver",  

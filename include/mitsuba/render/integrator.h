...
public:
    ...
    virtual std::pair<Spectrum, Mask> sample_reuse(const Scene *scene,
                                                   Sampler *sampler,
                                                   const RayDifferential3f &ray,
...
protected:
    ...
    virtual void render_block_reuse(const Scene *scene,
                                    const Sensor *sensor,
                                    Sampler *sampler,
                                    ImageBlock *block,
                                    Float *aovs,
    ...
    void render_sample_reuse(const Scene *scene,
                       const Sensor *sensor,
                       Sampler *sampler,
                       ImageBlock *block,
                       Float *aovs,
        ...
        void dump(std::string filename_w, std::vector<PixelCacheInfo> &block_records_w);
        void load(std::string filename_r, std::vector<PixelCacheInfo> &block_records_r);
        void spatial_merge_info(std::vector<PixelCacheInfo> &block_records_r, size_t reuse_size); 
...
protected:
    ...
    /// For reuse solutions
    bool m_reuse;
    uint32_t m_spatial_reuse_size;
    bool m_spatial_reuse_unique;
    bool m_pixel_reuse_unique;
    Float m_spatial_merge_threshold;
    Float m_pixel_merge_threshold;
    /// Spatial reuse file path
    std::string m_current_file_path_reuse;
    /// Temporal reuse file path
    std::string m_temporal_file_path_reuse;
    /// For temporal reuse 
    bool m_temporal_reuse;
};

...
public:
    ...
    using PixelCacheGlintInfo = PixelCacheGlintInfo<Float, Spectrum>;
    ...
    Spectrum specular_manifold_sampling_reuse(const Point3f &sensor_position,
                                        const SurfaceInteraction3f &si,
                                        ref<Sampler> sampler,
    ...
    std::tuple<Mask, Point2f, Point2f>
    sample_glint_reuse(const Point3f &sensor_position,
                 const EmitterInteraction &ei,
                 const SurfaceInteraction3f &si,

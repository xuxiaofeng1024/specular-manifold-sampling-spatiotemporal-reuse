...
public:
    ...
    Mask sample_path_reuse(const ShapePtr shape,
                     const SurfaceInteraction3f &si,
                     const EmitterInteraction &ei,
    ...
    Mask sample_seed_path(const ShapePtr shape,
                          ...
                          bool first_path,
                          const Point3f &p_start = Point3f(0.f));
    Mask sample_seed_path_reuse(const ShapePtr shape,
                     const SurfaceInteraction3f &si,
                     const EmitterInteraction &ei,
                     const Point3f &position_reuse,
                     ref<Sampler> sampler,
...
protected:
    ...
    //add⋅
    static std::atomic<size_t> stats_newton_solver_calls;
    static std::atomic<size_t> stats_newton_solver_iterations;

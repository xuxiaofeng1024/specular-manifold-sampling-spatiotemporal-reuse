...
def test_eval_spline(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.eval_spline(0, 0, 0, 0, 0.5), 0))
    assert(ek.allclose(spline.eval_spline(0, 0, 0, 0, 1), 0))
    assert(ek.allclose(spline.eval_spline(0, 1, 1, 1, 1), 1))
    assert(ek.allclose(spline.eval_spline(0, 1, 1, 1, 0), 0))
...
def test_eval_spline_d(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.eval_spline_d(0, 0, 0, 0, 0.5), (0.0, 0.0)))
    assert(ek.allclose(spline.eval_spline_d(0, 0, 0, 0, 1),   (0.0, 0.0)))
    assert(ek.allclose(spline.eval_spline_d(0, 1, 1, 1, 1),   (1.0, 1.0)))
    assert(ek.allclose(spline.eval_spline_d(0, 1, 1, 1, 0),   (0.0, 1.0)))
    assert(ek.allclose(spline.eval_spline_d(0, 1, 1, 1, 0.5), (0.5, 1.0)))
...
def test_eval_spline_i(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.eval_spline_i(0, 0, 0, 0, 0.5), (0.0, 0.0)))
    assert(ek.allclose(spline.eval_spline_i(0, 0, 0, 0, 1),   (0.0, 0.0)))
    assert(ek.allclose(spline.eval_spline_i(0, 1, 1, 1, 0),   (0.0, 0.0)))
    assert(ek.allclose(spline.eval_spline_i(0, 1, 1, 1, 0.5), (0.125, 0.5)))
    assert(ek.allclose(spline.eval_spline_i(0, 1, 1, 1, 1),   (0.5, 1.0)))
...
def test_eval_1d_non_uniform(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.eval_1d(nodes1, values2, 0.5), 0.5))
    assert(ek.allclose(spline.eval_1d(nodes1, values2, 1), 1))
...
def test_integrate_1d_uniform(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.integrate_1d(0, 1, values), res))
...
def test_invert_1d(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.invert_1d(0, 1, values, spline.eval_1d(0, 1, values, 0.6)), 0.6))
    values = Float([0.1, 0.2,  0.3, 0.35,  1])
    assert(ek.allclose(spline.invert_1d(0, 1, values, spline.eval_1d(0, 1, values, 0.26)), 0.26))
    assert(ek.allclose(spline.invert_1d(0, 1, values, spline.eval_1d(0, 1, values, 0.46)), 0.46))
...
def test_eval_2d(variant_scalar_rgb):
    ...
    assert(ek.allclose(spline.eval_2d(nodes_x, nodes_y, values, 0, 0),     0))
    assert(ek.allclose(spline.eval_2d(nodes_x, nodes_y, values, 1, 0),     1))
    assert(ek.allclose(spline.eval_2d(nodes_x, nodes_y, values, 0, 1),     0))
    assert(ek.allclose(spline.eval_2d(nodes_x, nodes_y, values, 1, 1),     1))
    assert(ek.allclose(spline.eval_2d(nodes_x, nodes_y, values, 0.5, 0.5), 0.5))
